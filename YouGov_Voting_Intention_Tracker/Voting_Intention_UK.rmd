...
links-as-notes: true
---
**Author:** `r "Clemens Jarnach"`  
**Date:** *`r format(Sys.Date(), '%B %d, %Y')`*  

```{R, include = FALSE}
##Packages ---------------------------
## install & load packages: 
want = c("ggplot2","data.table", "dplyr", "tidyr" ,"haven", "tidyverse", "tibble", "survey", "srvyr", "kableExtra" ,"knitr", "stargazer")
## amend list "want" with the pakcages needed
...
# Read tabular data into R
  dt <- read.table("data_perYear.txt", header = TRUE, sep = ",", dec = ".")
# LaTeX Table
 kableExtra::kable(dt, col.names = c("year","Con", "Lab", "LibDem", "SNP", "Grn","RefUK", "Other"), 
 caption = "Vote Share Yearly Averages (\\%)", format = "latex",  booktabs = TRUE) %>%
   kableExtra::kable_styling(position = "center", latex_options = "hold_position") %>%
   kableExtra::footnote(general = "Data: YouGov Westminster Voting Intension Tracker, Feb 2023",
           threeparttable = TRUE,
...
```{R fig1, echo = FALSE, fig.align = 'center', out.width = "80%", fig.cap = "Vote Intention for the Next UK General Election"}
knitr::include_graphics(rep("plot2.png"))
```
\
...
```{R voteExpect, echo = FALSE}
# Read tabular data into R
  dt <- read.table("data_think_perYear.txt", header = TRUE, sep = ",", dec = ".")
# LaTeX Table
 kableExtra::kable(dt, col.names = c("year", 
  "Large Con.",
  "Small Con.",
  "Hung Con.",
  "Hung Lab.",
  ...
  "Large Lab.",
  "Don't know"), 
 caption = "Electoral Expectations by Voters Yearly Averages (\\%)", format = "latex",  booktabs = TRUE) %>%
   kableExtra::kable_styling(position = "center", latex_options = "hold_position") %>%
   kableExtra::footnote(general = "Data: YouGov 'Who do people THINK will win the next election', Feb 2023",
           threeparttable = TRUE,
           general_title = "Source:",
           footnote_as_chunk = T, title_format = "italic")
```
...
```{R fig2, echo = FALSE, fig.align = 'center', out.width = "80%", fig.cap = "Electoral Expectations for the Next UK General Election as Perceived by the Voters"}
knitr::include_graphics(rep("plot3.png"))
```
